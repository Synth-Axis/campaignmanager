...
<div class="flex items-center justify-center mt-24">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <a href="/pm-home" class="group block rounded-2xl shadow-md bg-slate-800 transition p-6">
            <div class="flex items-center space-x-4">
                <div>
        ...
        <a href="/publico" class="group block rounded-2xl shadow-md bg-slate-800 transition p-6">
            <div class="flex items-center space-x-4">
                <div>
