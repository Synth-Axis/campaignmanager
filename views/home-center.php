...
<div class="flex items-center justify-center mt-24">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <a href="/pm-home" class="group block rounded-2xl shadow-md bg-slate-800 bg-opacity-50 transition transform hover:scale-105 p-6 border border-blue-600">
            <div class="flex items-center space-x-4">
                <div>
        ...
        <a href="/publico" class="group block rounded-2xl shadow-md bg-slate-800 bg-opacity-50 transition transform hover:scale-105 p-6 border border-blue-600">
            <div class="flex items-center space-x-4">
                <div>
        ...
        <a href="#" class="group block rounded-2xl shadow-md bg-slate-800 bg-opacity-50 transition transform hover:scale-105 p-6 border border-blue-600">
            <div class="flex items-center space-x-4">
                <div>
