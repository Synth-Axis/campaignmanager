...
<?php
$mostrarMenu = preg_match('/^\/(home|publico|campanhas|exportacoes)(\.php)?$/', $_SERVER['REQUEST_URI']);
?>
    ...
    <div id="drawer-navigation" class="fixed top-17 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-64 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
        ...
        <div class="py-4 overflow-y-auto">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="#" class="mt-4 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
