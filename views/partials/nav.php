    ...
    <div class="max-w-screen-xl mx-auto flex items-center justify-between p-4">
        ...
        <div class="flex items-center space-x-4">
            <?php if (!empty($_SESSION['user_id'])): ?>
                ...
                <a href="/logout">
                    <button class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-800">
                        Sair
                    </button>
                </a>
            <?php else: ?>
