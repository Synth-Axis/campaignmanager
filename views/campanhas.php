...
<main class="min-h-screen flex flex-col items-center mt-10 gap-8">
    ...
    <!-- TAB: Campanhas -->
    <section id="tab-campanhas" class="tab-content w-full max-w-4xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow p-8">
    ...
    <!-- TAB: Nova Campanha -->
    <section id="tab-nova-campanha" class="tab-content w-full max-w-7xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow p-8">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex justify-start mt-2">
                        <button type="button" id="preview-btn"
                            class="px-4 py-2 text-xs bg-blue-500 text-white rounded hover:bg-blue-700 mr-2">
                            Ver Preview
                        </button>
                        <button type="submit"
                            class="px-5 py-2 text-white bg-blue-600 rounded hover:bg-blue-700 font-medium">
                            Guardar Campanha
                        </button>
                    </div>
                </div>
